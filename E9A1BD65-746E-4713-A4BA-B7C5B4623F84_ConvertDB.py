...
class ConvertDBFiles_TAB:
    ...
    def __init__(self):
        ...
        self.db_restor_cmd = "RESTORE DATABASE [{0}] FROM DISK = N'{1}' WITH FILE = 1, MOVE N'{0}' TO N'{2}', MOVE N'{3}'TO N'{4}', RECOVERY, NOUNLOAD, STATS = 5, REPLACE"
...
if __name__ == '__main__':
    ...
    root_filepath = "C://Users//ISC-SA-EDG-SLA//Documents//Bakfiletest//"
